...
def find_nearest_color(input_rgb: tuple, df_color_dict: pd.DataFrame, dist_type: str = 'sRGB'):
...
if __name__ == '__main__':
    ...
    print(find_nearest_color(input_rgb, df_color_dict, dist_type='sRGB'))
    print(find_nearest_color(input_rgb, df_color_dict, dist_type='CIE76'))
    print(find_nearest_color(input_rgb, df_color_dict, dist_type='CIE94'))
